...
public class indexController {
	...
	public String registerMemberAdmin(HttpServletRequest request, @RequestBody HashMap<String, Object> body) {
		...
		Member mem = new Member((String)body.get("id"),(String)body.get("pw"), (String)body.get("email"), (String)body.get("phone"), (String)body.get("sex"), age == null ? 0 : age, weight == null ? 0 : weight,false, true);
