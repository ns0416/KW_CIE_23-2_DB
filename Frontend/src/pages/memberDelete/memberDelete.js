...
<div class={style.my}>
            ...
            <div class={style.out_box}>
            	<p class={style.remains}>회원님께서는<em>2024.05.23</em><span class={style.pwblock}>일까지 이용권 사용기간이 남아 있습니다.</span><br/><br/></p>
                ...
                <div class={style.btn}><a href="#" id="confirm">회원탈퇴</a></div>
            </div>
			    <form id="frm">
				</form>
        </div>
