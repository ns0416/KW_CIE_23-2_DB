...
export default function moveMemberCardRegiView() {
	return (
		<>
			<div className="wrap my" id="sub">
				...
				<div className="container">
					...
					<div className="my_navi">
						...
						<div className="tabs">
							<ul>
								<li id="memberNoteTab1" className="tab-1" onclick="location.href='/app/mybike/memberInfo/memberInfoEdit.do'">
					...
					<div className="content">
						<div className="category_tab">
							<dl>
								<dd id="member_manage_card"><a href="/app/mybike/moveMemberCardRegiView.do">환승카드 관리</a></dd>
							...
							<div id="card-tab-2" className="tab-content current">
								<div className="pay_info" style={{border :"0px"}}>
									<ul>
										...
										<li>환승마일리지 서비스 신청과 한국스마트카드의 정보제공에 동의하고, 대중교통 이용시 사용하는 교통카드를 등록하여야 합니다.후불교통카드의 경우, 등록하신 환승카드의 번호와 티머니에서 전송받은 대중교통 사용 내역의 카드번호가 일치하는 경우에 한하여 마일리지 적립이 진행되고 있습니다.  이용일 기준 4일 후, 마일리지 적립이 안 될 경우, 카드번호 확인이 필요합니다. 이경우 거래하고계신 카드사에 교통거래가 발생한 카드번호를 확인하여 등록하신 환승카드번호와 일치하는지 확인하여 주시기 바랍니다. 교통카드의 경우, 플라스틱 카드의 번호와 대중교통 이용내역[카드사에서 티머니로 제공]에서 제공하는 카드번호가 상이하여 마일리지 누락이 일어날 수 있습니다.</li>
										<li style={{color: "red"}}>※ 현재 KBANK, 신한 아멕스카드15자리, 지하철 정기권, 모바일 페이 등의 경우  카드사 정책에 의해 적립이 불가하오니, 해당 카드이외의 카드 사용을 부탁드립니다.  티머니 기능이 있는 후불교통카드 등 카드 한장에 두 개의 신용카드 번호가 존재하는 경우, 대중교통 결제시 이용되는 카드번호를 반드시 확인하여주시기 바랍니다</li>
										<li><a href="/info/infoReg.do#tab-5">대중교통 환승마일리지 안내 바로가기</a></li>
									</ul>
								</div>
								<section id="confirmForm" style={{display: "none"}}>
									...
									<div className="my_info" style={{border :"0px"}}>
										...
										<div className="check agree"><input type="checkbox" name="check4" id="check4" /><label for="check4"><span></span>환승마일리지 서비스 신청과 ㈜티머니의 정보제공에 동의합니다.</label></div>
									</section>
			...
			<div id="frogue-container" className="position-right-bottom"
