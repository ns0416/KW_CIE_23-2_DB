...
// var tooltip = $('<div style="position:absolute;z-index:100000;padding:5px 10px;background-color:#fff;border:solid 2px #000;font-size:14px;pointer-events:none;display:none;"></div>');
...
// nMap.markerSmallTypeImages = ["/img/icon_s0.png","/img/icon_s1.png","/img/icon_s1.png","/img/icon_s1.png","/img/icon_s1.png"];
// nMap.markerTypeImages = ["/img/icon_b0.png","/img/icon_b1.png","/img/icon_b1.png","/img/icon_b1.png","/img/icon_b1.png"];
// nMap.markerBigTypeImages = ["/img/icon_big0.png","/img/icon_big1.png","/img/icon_big1.png","/img/icon_big1.png"];
...
// 				this.alert("추가배치 요청이 완료되었습니다.\n시민님의 요청사항은 해당지역 배차요원에게 전달되며,\n자전거 분배 및 추후 대여소 증설 검토시 참고자료로 활용됩니다.\n따릉이에 많은 관심을 가져주셔서 감사드리며 안전운행 하시기 바랍니다.\n* 본 요청은 별도의 알람이 가지 않습니다.");
// 			}
...
// 							totalCnt = Number(realStationList[i].parkingBikeTotCnt);
// 						}else{
// 							totalCnt = 0;
// 						}
// 					}else if(tabId == "qr"){
...
// 					}else if(tabId == "yg"){
// 						if(realStationList[i].stationSeCd == "RAK_001"){
// 							totalCnt = Number(realStationList[i].parkingELECBikeCnt);
// 						}else if(realStationList[i].stationSeCd == "RAK_002"){
// 							totalCnt = Number(realStationList[i].parkingELECBikeCnt);
// 						}else{
// 							totalCnt = 0;
...
// 					j++;
// 				}else if(tabId == "yg"){
// 					if(realStationList[i].stationSeCd == "RAK_001" || realStationList[i].stationSeCd == "RAK_002"){
// 						var marker = new naver.maps.Marker(markerOptions);
// 						markers.push(marker);
// 						naver.maps.Event.addListener(markers[j], 'click', getClickHandler(
// 							  timehtml
